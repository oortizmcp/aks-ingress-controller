...
ACR_URL=ooaksacrprivdemo.azurecr.io
...
tar -xvf ingress-nginx-3.36.0.tgz
...
az acr repository show --name $REGISTRY_NAME --repository helm/ingress/ingress-nginx-3.36.0
...
-f ./aks-ingress-controller/ingress/internal-ingress.yaml

kubectl apply -f ./aks-ingress-controller/ingress/aks-helloworld.yaml  --namespace ingress-basic
kubectl apply -f ./aks-ingress-controller/ingress/ingress-demo.yaml  --namespace ingress-basic

kubectl delete validatingwebhookconfigurations oovingress-ingress-nginx-admission

kubectl apply -f ./aks-ingress-controller/ingress/hello-world-ingress.yaml  --namespace ingress-basic